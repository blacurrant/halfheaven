    ...
    <main style={{ maxWidth: 800, margin: "0 auto", padding: "48px 20px 110px" }}>
      ...
      <section style={{ marginTop: 30 }}>
        ...
        <div style={{ marginTop: 14, display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
          <button
            className="h-[38px] px-4 rounded-full font-semibold text-sm inline-flex items-center gap-1.5 border-[1.5px] bg-[var(--accent)] border-[var(--accent)] text-[var(--on-accent)] hover:bg-[var(--accent-press)] whitespace-nowrap"
        ...
        <Section title="Your edit">
          ...
          <div style={{ marginTop: 18 }}>
            {score ? <Scorecard score={score} /> : (
              <button className="h-8 px-[13px] text-[13.5px] inline-flex items-center gap-1.5 rounded-full font-semibold border-[1.5px] border-[var(--line-2)] bg-[var(--card)] whitespace-nowrap" onClick={runScore} disabled={scoring}>
